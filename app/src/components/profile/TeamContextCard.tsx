            ...
            <CardContent className="space-y-6">
                ...
                {squad && (
                    <div>
                        ...
                        <Link to="/squads/$squadId/edit" params={{ squadId: squad.id }} className="block group">
                ...
                {contact?.reportsTo && (
                    <div>
                        ...
                        <Link to="/employees/$employeeId" params={{ employeeId: contact.reportsTo.id }} className="block group">
